...
// Create a new book (excluding bookID, which will be generated by the backend)
const NewBookForm = ({ onSuccess, onCancel }: NewBookFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    await addBook(formData); // ✅ No bookID passed
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-grid">
        {/* Form inputs for all book fields except ID */}
        <label>
          Title:
          <input
            type="text"
